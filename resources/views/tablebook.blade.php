            ...
            <div class="col-sm-4">
               ...
               <div class="col-sm-4 ">
                    <form class="contact-form" action="submit" method="post">
                        ...
                        <br>
                        <label> Mit dem Absenden der Reservierung </label><br>
                        <label>      erkläre ich mich mit den</label><br>
                        <label>Datenschutzrechtlinien einverstanden. </label><br>
                        <br>
                        ...
                        <br>
                          <input type="email" style="border-radius: 5px; width: 250px ; height : 25px;" placeholder="Email" name="email" value="{{auth()->user()->email??'email'}}" required readonly><br>

                        <br>
                        <textarea name="message"  style="border-radius: 5px; width: 250px ; height : 100px;" placeholder="Nachricht"></textarea>
                        <br>
                        <br>
                        <button type ="submit" style="border-radius: 5px; width: 250px ; height : 50px; background-color: green " name="submit"> Reservierung absenden </button><br>
